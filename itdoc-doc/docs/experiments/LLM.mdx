...
**Do you have too many APIs to document in your project, making it difficult to manually specify tests for Itdoc?**
...
- Test Case: Test case title
  ...
  - Expected Response: Description of the expected response
```

Here are examples for various API cases:

<Tabs>
    <TabItem value="auth" label="🔐 Authentication API" default>
        ...
        - Expected Response: Status code 200, JSON response with secret message and specific headers
        - Test Case: Unauthorized access
        - Request: Send GET request with invalid authentication header
        - Expected Response: Returns status code 401
        ```

    </TabItem>
    <TabItem value="file" label="📁 File Upload API">
        ...
        - Expected Response: Status code 200, JSON response with image URL
        - Test Case: Wrong content type
        - Request: Send POST request without "multipart/form-data" content type
        - Expected Response: Status code 400, JSON response with error message
        ```
